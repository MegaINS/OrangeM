...
import ru.megains.orangem.common.network.handler.INetHandlerLoginServer
import ru.megains.orangem.common.network.packet.login.client.CPacketLoginStart
import ru.megains.orangem.common.network.packet.login.server.SPacketLoginSuccess
import ru.megains.orangem.server.OrangeMGServer
import ru.megains.orangem.server.entity.EntityPlayerMP

class NetHandlerLoginServer(server: OrangeMGServer, networkManager: NetworkManager) extends INetHandlerLoginServer /*with ITickable*/ {

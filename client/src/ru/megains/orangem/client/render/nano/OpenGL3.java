package ru.megains.orangem.client.render.nano;//package ru.megains.orangem.client.render.nano;
//
//
//import imgui.Cond;
//import imgui.ImGui;
...
//        window = GlfwWindow.from(Window.window().id()); // = new GlfwWindow(1280, 720, "Dear ImGui GLFW+OpenGL3 OpenGL example", null, new Vec2i(30), true);

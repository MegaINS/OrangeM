package ru.megains.orangem.client.render.nano;
//
...
//            if (CLICK == action) {
//                mouseTargetLabel.getStyle().setDisplay(mouseTargetLabel.isVisible() ? DisplayType.NONE : DisplayType.MANUAL);
//            }
//            if (RELEASE == action) {
...
//        imageView.setPosition(105, 5);
//        imageView.getStyle().setPadding(50,50);
...
//        Button button = new Button(200, 200, 50, 20); /*button.getStyle().getBackground().setColor(new Vector4f(1));*/
//        button.getListenerMap().addListener(MouseClickEvent.class, (MouseClickEventListener) System.out::println);
//        button.getStyle().getBackground().setIcon(new ImageIcon(new Vector2f(100,100), imageView.getImage()));
//

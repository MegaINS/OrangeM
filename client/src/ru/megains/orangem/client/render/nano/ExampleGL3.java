...
//import static ru.megains.orangem.client.render.nano.NanoVGUtils.*;
//
///*
...
//    PerfGraph cpuGraph;
//    PerfGraph gpuGraph;
//    NanoVGUtils.GPUtimer gpuTimer;
//    DemoData data;
//    long vg;
//
//    public ExampleGL3(String[] args,long window){
//
//
//
//        glfwSetKeyCallback(window, (windowHandle, keyCode, scancode, action, mods) -> {
...
//            glfwWindowHint(GLFW_SAMPLES, 8);
//        }
//        vg = nvgCreate(DEMO_MSAA ? 0 : NVG_ANTIALIAS);
//
//        if (vg == NULL) {
//            throw new RuntimeException("Could not init nanovg.");
//        }
...
//        glfwSetTime(0);
//        prevt = glfwGetTime();
//        gpuTimer = new NanoVGUtils.GPUtimer();
//        initGPUTimer(gpuTimer);
//    }
//
//

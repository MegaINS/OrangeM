...
import ru.megains.orangem.client.render.api.TRenderTileEntity
import ru.megains.orangem.client.render.block.{RenderBlockStandard, RendererMiniBlock, TRenderBlock}
import ru.megains.orangem.client.render.entity.TRenderEntity
import ru.megains.orangem.client.render.item.{RenderItemBlock, RenderItemStandart, TRenderItem}
import ru.megains.orangem.common.block.{Block, BlockAir, MiniBlock}
import ru.megains.orangem.common.entity.Entity
import ru.megains.orangem.common.item.{Item, ItemBlock}
import ru.megains.orangem.common.register.{GameRegister, RegisterRender, TGameRegister}
import ru.megains.orangem.client.render.block.TRenderBlock
import ru.megains.orangem.client.render.item.RenderItemStandart
...
object GameRegisterRender extends TGameRegister {
    ...
    def registerEntityRender(tileEntity: Class[_ <: Entity], aRenderBlock: TRenderEntity): Unit = {
        val id: Int = GameRegister.getIdByEntity(tileEntity)
        if (id != -1) {

package ru.megains.orangem.common.world.region

import Region.ChunkOutputStream
...
class Region(regionFile: File) extends Logger[Region] {
    ...
    def setOffset(index: Int, offset: Int): Unit = {
...
object Region {
    ...
    private class ChunkOutputStream(index: Int, region: Region) extends ByteArrayOutputStream(OFFSET_LENGTH) {

package ru.megains.orangem.common.network
...
class NetworkManager(packetProcess: PacketProcess) extends SimpleChannelInboundHandler[Packet[INetHandler]] with Logger[NetworkManager] {
